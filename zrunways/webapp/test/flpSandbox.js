					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Runways Roadways",
									"targetURL": "#zrunways-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zrunways-display": {
								"semanticObject": "zrunways",
								"action": "display",
								"description": "Runways Roadways Demo App",
								"title": "Runways Roadways",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zrunways",
									"url": sap.ui.require.toUrl("zrunways")
								}
							}
						}
					}
